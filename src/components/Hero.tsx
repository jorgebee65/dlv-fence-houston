        ...
        <div className="max-w-screen-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 md:items-end justify-between reveal-3">
            ...
            <a 
              ...
              className="inline-flex items-center justify-center border-2 border-brand-amber text-brand-amber hover:bg-brand-amber hover:text-brand-black font-display text-xl md:text-3xl px-6 py-3 md:px-10 md:py-5 transition-colors duration-0 w-full md:w-max"
            >
              Get a Quote &rarr;
            </a>
          </div>
