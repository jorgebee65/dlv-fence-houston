      ...
      <div className="px-4 sm:px-8 mt-12 md:mt-0 relative z-10">
        <div className="max-w-screen-2xl">
          ...
          <h1 className="font-display text-6xl sm:text-8xl md:text-[10rem] lg:text-[12rem] leading-[0.85] md:leading-[0.8] tracking-tight text-white mb-8 md:mb-10 reveal-2 mix-blend-exclusion">
            WE <span className="text-brand-amber">FORGE</span>
            <br /> 
            HOUSTON
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:items-end justify-between reveal-3">
            <div className="space-y-6 max-w-xl">
              <p className="font-body text-brand-gray text-base sm:text-lg md:text-2xl font-medium leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-brand-steel pt-6">
                <div>
                  <p className="font-display text-brand-amber text-lg mb-1 tracking-wider">English</p>
                ...
                <div>
                  <p className="font-display text-brand-amber text-lg mb-1 tracking-wider">Español</p>
            ...
            <a 
              ...
              className="inline-flex items-center justify-center border-2 border-brand-amber text-brand-amber hover:bg-brand-amber hover:text-brand-black font-display text-xl md:text-3xl px-6 py-3 md:px-10 md:py-5 transition-colors duration-0 w-full md:w-max mb-1"
            >
              Get a Quote &rarr;
            </a>
          </div>
